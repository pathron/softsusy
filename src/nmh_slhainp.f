...
*     May need these for problem point test.
     ...
     C     CST,CSB,CSL,MSMU1,MSMU2,MSMUNT,CSMU
      ...
      DOUBLE PRECISION M0,M12,A0,ALGUT,AKGUT
      DOUBLE PRECISION M1GUT,M2GUT,M3GUT,ATGUT,ABGUT,
...
*   READ Q2 AND TANBETA
      ELSEIF(CHBLCK(1:6).EQ.'MINPAR')THEN
       ...
       IF(IX.EQ.2) M12=VAL
       IF(IX.EQ.5) A0=VAL
*   READ Q2 from BLOCK EXTPAR
      ELSEIF(CHBLCK(1:6).EQ.'EXTPAR')THEN
       READ(CHINL,*,ERR=999) IX,VAL
       IF(IX.EQ.63) ALGUT = VAL
